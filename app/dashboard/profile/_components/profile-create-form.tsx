...
const ProfileCreateForm: React.FC<ProfileFormType> = ({ initialData }) => {
  ...
  const title = initialData ? 'Edit project' : 'Create Your Profile';
  ...
  //     setLoading(true);
  //     if (initialData) {
  //       // await axios.post(`/api/products/edit-project/${initialData._id}`, data);
  //     } else {
  //       // const res = await axios.post(`/api/products/create-project`, data);
